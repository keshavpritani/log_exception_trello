...
def createCard(program_name, exception_name, card_desc,exceptions_list):
    ...
    if exception_name in exception_list:
        #print("hello")
        updateCard(exception_list[exception_name])
        return
    ...
    if(200 <= response.status_code < 300):
        exception_list[exception_name] = json.loads(response.text)['id']
